...
export const store = createStore ({
  state: {
    ...
    daoQuery : '',
    dataCollection : '',
    selectedProjectClass: 'biz',
    selectedtaskClass: 'ccs',
    taskSubClass: 'cgs',
    packageName: '',
    projectName : 'CgsCarUse',
    logicalName: 'logicName',
    projectRoot : 'kr.re.kitech.',
    tableName: 'tableName',    
    projectClassStatements : [
      {name: "biz"},
      {name: "eip"},
      {name: "mobile"},
    ],
    taskClassStatementsEip : [
      {name:"main", desc: "main"},
      {name:"portal", desc: "portal"},
      {name:"api", desc: "api"},
      {name:"collpack", desc: "collpack"},
      {name:"lightpack", desc: "lightpack"},
      {name:"socialpack", desc: "socialpack"},
      {name:"support", desc: "support"},
      {name:"util", desc: "util"},
      {name:"xom", desc: "xom"},
      {name:"zam", desc: "zam"},
    ],
    taskClassStatementsBiz : [
      {name: "ass", desc: "자산관리"},
      {name: "ccs", desc: "총무보안"},
      {name: "epu", desc: "구매조달"},
      {name: "fin", desc: "재무예산"},
